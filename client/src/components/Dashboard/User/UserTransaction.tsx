      ...
      <div className="flex overflow-hidden pt-10">
        ...
        <div className="w-[30%] flex flex-col gap-2 items-center shadow-2xl py-5">
          ...
          <div className="w-full flex gap-5 justify-center">
            <div
              className="w-[40%] text-center py-1 bg-red-600 text-white font-semibold rounded-md cursor-pointer"
              onClick={() => navigate("/walter-wallet/user/gave")}
            >
              You Gave Rs.
            </div>
            <div
              className="w-[40%] text-center py-1 bg-green-600 text-white font-semibold rounded-md cursor-pointer"
              onClick={() => navigate("/walter-wallet/user/got")}
            >
              You Got Rs.
            </div>
          </div>
